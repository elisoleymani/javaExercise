public class AreaCalculator {
    public static void main(String[] args) {
        ...
        double rectangle = areaRectangle(8, 3);
        double triangle = areaTriangle(22, 4);
        double circle = areaCircle(9);
    ...
    public static double areaSquare(double side) {
        ...
        double areaSquareValue = Math.pow(side, 2);
        return areaSquareValue;
    ...
    public static double areaRectangle(double length, double width) {
        ...
        double areaRectangleValue = length * width;
        return areaRectangleValue;
    ...
    public static double areaTriangle(double base, double height) {
        ...
        double areaTriangleValue = (base * height) / 2;
        return areaTriangleValue;
    ...
    public static double areaCircle(double radius) {
        ...
        double areaCircleValue = Math.PI * Math.pow(radius, 2);
        return areaCircleValue;
